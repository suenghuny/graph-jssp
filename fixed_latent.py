...
class FixedLatentModel(nn.Module):
    """
    ...
    def calculate_loss(self, X, A, train = False):
        ...
        z = self.sample_posterior(mean_feature) # q(|G
        ...
        return edge_loss, node_loss, None, mean_feature, features, z
