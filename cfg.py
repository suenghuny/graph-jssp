...
def get_cfg():
    ...
    parser.add_argument("--step", type=int, default=90000, help="")
    ...
    parser.add_argument("--reward_scaler", type=float, default=3000, help="")
    ...
    parser.add_argument("--fixed_VG2S", type=bool, default=False, help="")
